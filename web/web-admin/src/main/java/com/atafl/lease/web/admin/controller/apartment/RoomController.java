...
import com.atafl.lease.web.admin.service.RoomInfoService;
...
public class RoomController {
    ...
    @GetMapping("listAvailableByDistrictId")
    @Operation(summary = "根据区县id查询未出租房间列表")
    public Result<List<RoomItemVo>> listAvailableByDistrictId(@RequestParam Long districtId) {
        List<RoomItemVo> result = service.getAvailableRoomsByDistrictId(districtId);
        return Result.ok(result);
    }
