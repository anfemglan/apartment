...
import com.atafl.lease.web.admin.vo.attr.AttrValueVo;
...
public class RoomInfoServiceImpl extends ServiceImpl<RoomInfoMapper, RoomInfo>
    ...
    @Override
    public List<RoomItemVo> getAvailableRoomsByDistrictId(Long districtId) {
        return roomInfoMapper.getAvailableRoomsByDistrictId(districtId);
    }
}
