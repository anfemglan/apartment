package com.atafl.lease.web.app.controller.room;
...
public class RoomController {
    ...
    public Result<IPage<RoomItemVo>> pageItem(@RequestParam long current, @RequestParam long size, RoomQueryVo queryVo) {
        ...
        IPage<RoomItemVo> result = roomService.pageItem(page,queryVo);
    ...
    public Result<RoomDetailVo> getDetailById(@RequestParam Long id) {
        RoomDetailVo result = roomService.getDetailById(id);
        return Result.ok(result);
    }
    ...
    public Result<IPage<RoomItemVo>> pageItemByApartmentId(@RequestParam long current, @RequestParam long size, @RequestParam Long id) {
        Page<RoomItemVo> page = new Page<>(current, size);
        IPage<RoomItemVo> result = roomService.pageIdItem(page,id);
        return Result.ok(result);
    }
}
