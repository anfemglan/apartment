package com.atafl.lease.web.app.controller.leasaterm;

import com.atafl.lease.common.result.Result;
import com.atafl.lease.model.entity.LeaseTerm;
import com.atafl.lease.web.app.service.LeaseTermService;
...
public class LeaseTermController {
    ...
    public Result<List<LeaseTerm>> list(@RequestParam Long id) {
        List<LeaseTerm> list = leaseTermService.getListByRoomId(id);
